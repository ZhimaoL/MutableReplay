...
public class ExportedSerializableLog implements Serializable {
    ...
    public static Object[] aLogArg = new Object[1];

    public static int[] iLogArg = new int[1];
    
    public static long[] jLogArg = new long[1];
    
    public static float[] fLogArg = new float[1];
    
    public static double[] dLogArg = new double[1];
    
    public static byte[] bLogArg = new byte[1];

    public static boolean[] zLogArg = new boolean[1];

    public static char[] cLogArg = new char[1];

    public static short[] sLogArg = new short[1];
